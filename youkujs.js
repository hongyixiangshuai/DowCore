...
dynamicLoading.css(YK.https + "//player.youku.com/unifull/css/unifull.min.css?v=20180906");
...
YoukuPlayerSelect.prototype = {
  ...
  selectHandler: function() {
    ...
    if (this.isPC()) {
      ...
      url = YK.https + "//player.youku.com/unifull/js/unifull.min.js?v=20190108";
    }
  ...
  selectMobileH5: function() {
    ...
    var config = {
      ...
      password:"123456",// self._password, //瑙嗛鎾斁瀵嗙爜锛岀敤浜庡姞瀵嗚棰戯紙杩欎釜鏄惁鍙互浼犲叆鏆傚畾锛�
