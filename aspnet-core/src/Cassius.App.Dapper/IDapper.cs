...
namespace Cassius.App.Dapper
{
    public interface IDapper : IDisposable
    {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        Task<IPagedResult<T>> QueryPageAsync<T>(string countSql, string dataSql, int pageindex, int pagesize, object param = null, int? commandTimeout = null);
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        Task<IPagedResult<dynamic>> QueryPageAsync(string countSql, string dataSql, int pageindex, int pagesize, object param = null, int? commandTimeout = null);
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        IPagedResult<T> QueryPage<T>(string countSql, string dataSql, int pageindex, int pagesize, object param = null, int? commandTimeout = null);
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        IPagedResult<dynamic> QueryPage(string countSql, string dataSql, int pageindex, int pagesize, object param = null, int? commandTimeout = null);
