...
{
    public abstract class DapperBase : IDapper
    {
        ...
        protected DapperBase(string connectionString)
        {
            Conn = new Lazy<IDbConnection>(() => CreateConnection(connectionString));
        }
        ...
        public virtual async Task<IPagedResult<T>> QueryPageAsync<T>(string countSql, string dataSql, int pageindex, int pagesize, object param = null, int? commandTimeout = null)
        {
            if (pageindex < 1)
        ...
        public virtual async Task<IPagedResult<dynamic>> QueryPageAsync(string countSql, string dataSql, int pageindex, int pagesize, object param = null,
        ...
        public virtual IPagedResult<T> QueryPage<T>(string countSql, string dataSql, int pageindex, int pagesize, object param = null, int? commandTimeout = null)
        {
            if (pageindex < 1)
                throw new ArgumentException("The pageindex cannot be less then 1.");
            if (pagesize < 1)
        ...
        public virtual IPagedResult<dynamic> QueryPage(string countSql, string dataSql, int pageindex, int pagesize, object param = null,
            int? commandTimeout = null)
        {
            if (pageindex < 1)
                throw new ArgumentException("The pageindex cannot be less then 1.");
